...
variable "okta_user_first_name"{
  default = "Suhnndnbbanbba" 
}
variable "okta_user_last_name"{
  default = "Sindndbghnnha"
}
variable "okta_user_login"{
  default = "sohbddannbnana@gmail.com"
}
variable "okta_user_email"{
  default = "sohgddjhanabjba@gmail.com"
}

### Group ###

variable "okta_group_name"{
  default = "prjbddodubjnction envaabjb"
}
variable "okta_group_description"{
  default = "thidds is pbjnfbronmmd group envaanb"
}
...
variable "okta_auth_server_description" {
  default = "My Examddnbn  ple Anbuth Serverggaaar"
}
 
variable "okta_auth_server_name"{
  default = "debbnddbmo aunknth serverhbhaaabjbk"
}
...
variable "okta_app_saml_label"{
  default = "ufbmdhbnddbhh"
}

variable "okta_app_saml_sso_url" {
  default = "http://usern.com"
}
...
variable "okta_app_saml_audience" {
  default = "http://usern.com/audience"
}
...
variable "okta_idp_social_name"{
  default = "testhbbbdddnnbbjbjaaab"
}
